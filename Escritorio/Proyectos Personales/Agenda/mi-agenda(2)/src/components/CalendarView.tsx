                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          onClick={async () => {
                            ...
                            const rawText = `👋 Hola *${contact.fullName || 'Paciente'}*, te recordamos tu turno en el Consultorio Odontológico con *${dentistName}*:\n\n📅 *Fecha:* ${selectedApptDetail.date}\n⏰ *Hora:* ${selectedApptDetail.time} hs\n\nPor favor toca un enlace para responder con un solo toque:\n\n✅ *CONFIRMAR ASISTENCIA:*\n${confirmUrl}\n\n❌ *CANCELAR / REPROGRAMAR:*\n${cancelUrl}\n\n¡Muchas gracias! Consultorio Odontológico 🦷✨`;
