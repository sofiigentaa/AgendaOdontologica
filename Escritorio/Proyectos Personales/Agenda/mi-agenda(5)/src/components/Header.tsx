                ...
                <div className="absolute right-0 mt-1.5 w-72 sm:w-80 bg-white text-slate-800 rounded-2xl shadow-2xl border border-slate-200 p-2 z-50 animate-in fade-in zoom-in-95">
                  ...
                  <div className="py-1 space-y-0.5">
                    ...
                    >
                      ...
                      <div>
                        <p className="font-bold text-slate-900 text-xs leading-tight">Importar Copia de Seguridad (.json)</p>
                        <p className="text-[10.5px] text-slate-500 leading-tight">Carga una copia previa guardada</p>
                      </div>
                    </button>
