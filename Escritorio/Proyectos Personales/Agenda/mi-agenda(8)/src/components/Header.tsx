        ...
        <div className="flex items-center justify-between gap-3 flex-wrap sm:flex-nowrap">
          ...
          <div className="flex items-center gap-2 shrink-0 ml-auto sm:ml-0">
            ...
            <div className="relative shrink-0" ref={backupMenuRef}>
                ...
                <div className="absolute right-0 mt-1.5 w-72 sm:w-80 bg-white text-slate-800 rounded-2xl shadow-2xl border border-slate-200 p-2 z-50 animate-in fade-in zoom-in-95">
                  ...
                  <div className="py-1 space-y-0.5">
                    ...
                    >
                      ...
                      <div>
                        <p className="font-bold text-slate-900 text-xs leading-tight">Copia Completa de Respaldo (.json)</p>
                    ...
                    >
                      ...
                      <div>
                        <p className="font-bold text-slate-900 text-xs leading-tight">Importar Copia de Seguridad (.json o .txt)</p>
                        <p className="text-[10.5px] text-slate-500 leading-tight">Carga archivos .json o listas en .txt</p>
                      </div>
                    </button>
              ...
              {/* Hidden file input for JSON and TXT import */}
              <input
                ref={fileInputRef}
                type="file"
                accept=".json,.txt"
