          ...
          <div className="flex items-center gap-2">
            {currentShift && (
              <button
                type="button"
                onClick={handlePrint}
                className="hidden xs:flex sm:flex items-center gap-1 px-2.5 py-1 rounded bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-xs transition-colors"
                title="Imprimir comprobante térmico de caja"
              >
        ...
        {currentShift && (
          <div className="bg-slate-100 border-b border-slate-200 px-4 py-2 flex items-center justify-between gap-2">
            ...
            <button
              type="button"
              onClick={handlePrint}
              className="flex items-center gap-1 px-2.5 py-1 rounded bg-slate-900 hover:bg-slate-800 text-white text-xs font-semibold transition-all shadow-2xs"
            >
              <Printer className="w-3.5 h-3.5" />
