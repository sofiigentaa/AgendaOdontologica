    ...
    <div className="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white w-full max-w-sm rounded-lg shadow-xl border border-slate-200 overflow-hidden transform animate-in fade-in zoom-in duration-150">
        ...
        <div className="bg-emerald-600 px-4 py-2.5 text-white flex items-center justify-between">
          ...
          <button onClick={onClose} className="text-white/80 hover:text-white text-xs">✕</button>
        </div>

        {/* Printable Thermal Receipt Container */}
        <div className="printable-receipt p-4 space-y-3 font-mono text-xs text-slate-800 bg-slate-50/50 border-b border-dashed border-slate-300 print:p-0 print:border-none">
