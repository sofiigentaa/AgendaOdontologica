      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-3.5 rounded-lg border border-slate-200 shadow-xs">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          <button
            ...
            className="px-2.5 py-1.5 rounded bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold transition-all border border-slate-200 flex items-center gap-1"
          ...
          <button
            ...
            className="px-2.5 py-1.5 rounded bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold transition-all border border-slate-200 flex items-center gap-1"
            title="Imprimir lista completa de precios y stock del inventario"
          >
          ...
          <button
            ...
            className="px-3 py-1.5 rounded bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold transition-all shadow-xs flex items-center gap-1.5"
          >
                      ...
                      <td className="py-2 px-3 text-center">
                        <div className="flex items-center justify-center gap-1">
                          ...
                          <button
                            ...
                            className="p-1 bg-indigo-50 hover:bg-indigo-600 text-indigo-600 hover:text-white rounded transition-colors"
