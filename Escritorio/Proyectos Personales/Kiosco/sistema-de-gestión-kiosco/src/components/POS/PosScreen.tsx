  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        ...
        <div className="lg:col-span-5" id="pos-ticket-container">
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden sticky top-20">
            ...
            {/* Cart Items List */}
            <div className="p-3 max-h-[340px] overflow-y-auto divide-y divide-slate-100 text-[13px]">
              {cart.length === 0 ? (
                  ...
                  <div key={item.product.id} className="py-2 flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1 bg-slate-100 p-0.5 rounded border border-slate-200">
                      <button
                        ...
                        className="w-5 h-5 rounded bg-white text-slate-700 hover:bg-slate-200 flex items-center justify-center transition-colors text-xs"
                      >
      ...
      {showCheckoutModal && (
        <div className="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white w-full max-w-lg rounded-lg shadow-xl border border-slate-200 overflow-hidden transform animate-in fade-in zoom-in duration-150">
      ...
      {cart.length > 0 && (
        <div className="lg:hidden fixed bottom-0 left-0 right-0 z-30 bg-slate-900 border-t border-slate-800 text-white p-3 shadow-2xl animate-in slide-in-from-bottom duration-200">
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-[10px] text-slate-400 font-semibold uppercase">Total Ticket</div>
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => {
                  const ticketEl = document.getElementById('pos-ticket-container');
              ...
              <button
                ...
                className="px-4 py-1.5 rounded bg-green-600 hover:bg-green-700 text-white text-xs font-bold shadow-xs flex items-center gap-1.5"
              >
